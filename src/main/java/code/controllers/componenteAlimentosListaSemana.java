...
public class componenteAlimentosListaSemana {
    ...
    public void initialize(){
        ...
        if(main.adminApp.getAlimentosDisponibles().size()== 0) return;
            ...
            main.adminApp.getListaPorSemana().forEach( alimento -> {
                ...
                alimentoLabel.setOnMouseClicked( a ->{
                    try{
                        ...
                        confirmButton.setOnAction(event -> {
                            main.adminApp.borrarAlimentoListaSemana( alimento );
                            popup.hide();
                            this.initialize();
                        });
    ...
    public void agregarAlimentos(){
        ...
        containerEspacios.getChildren().add(extraerFormulario("crearAlimentoListaSemana"));
